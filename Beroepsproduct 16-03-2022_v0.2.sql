...
-- Data Vreemdelinge_Registratie
INSERT ALL INTO vreemdelinge_registratie VALUES (
    1,
    'Smith',
    'Brenda Shay',
    'Amerikaanse',
    '10 oct 1991',
    0
) INTO vreemdelinge_registratie VALUES (
    2,
    'Wu',
    'Patrick Eric',
    'Chinese',
...
CREATE TABLE ingezetene (
    ...
    -- Data Ingezetene
INSERT ALL INTO ingezetene (
    ingezetene_id,
    id_nummer,
    adres,
    district,
    vreemdelinge_registratie_id
) VALUES (
    1,
    'AA2123',
    'Zinkstraat 02',
...
CREATE OR REPLACE TRIGGER trigger_geboorte_akte_audit BEFORE
    INSERT OR DELETE OR UPDATE ON geboorte_akte
    FOR EACH ROW
ENABLE BEGIN
    IF inserting THEN
